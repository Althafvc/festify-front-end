...
function AdminHome() {
  return (
    <>
    <div className="wrapper md:w-full md:h-full md:pb-0  bg-[#a5f5bd] flex md:flex-row xxs:justify-center lg:gap-20 xl:gap-22 xxs:py-10 md:pt-0 ">
      ...
      <div className="slate w-auto xxs:px-10 lg:px-20 xxs:pt-8 xxs:pb-10 h-auto pb-10 bg-[#89deba] rounded-2xl xxs:flex xxs:flex-col xxs:gap-7 xs:gap-5 lg:py-0 2xl:pb-10 2xl:pl-20 2xl:pr-36 md:mt-">
        <div className="heading xxs:w-full h-auto xxs:flex xxs:justify-center xxs:items-center">
          <h1 className='font-aclonica text-[#06744C] xxs:text-xl sm:text-2xl md:text-3xl md:mt-  xl:text-5xl 2xl:text-6xl xl:mt-6 2xl:mt-8'>PROGRAM NAME</h1>
        </div>
